...
public class Sockets {
    ...
    /*
 Este metodo escuchar  lo que hace es abrir un socket en un especifico puerto para recibir algo
  */
    public void Listen(int puerto){
        //mihilo.start();
        try {
    ...
    */
    public void send(String ip ,int puerto,String mensaje) throws IOException {
