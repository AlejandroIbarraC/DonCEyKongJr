...
public class MainWindowController implements Initializable {
    ...
    void createKremlin(ActionEvent event) throws IOException {
        ...
        if (kremlin == null || posI.equals("") || posJ.equals("") || currentPlayer == 0){
            ...
            switch (kremlin){
                case "Red Crocodile":
                    Crocodile redKremlin = new Crocodile(Integer.valueOf(posI), Integer.valueOf(posJ), 21);
                    game.addEnemy(redKremlin, currentPlayer);
                    System.out.println("Rojo");
                    break;
                case "Blue Crocodile":
                    Crocodile blueKremlin = new Crocodile(Integer.valueOf(posI), Integer.valueOf(posJ), 22);
    ...
    private void loadChoiceBoxes(){
        ...
        String red = "Red Crocodile";
        String blue = "Blue Crocodile";
